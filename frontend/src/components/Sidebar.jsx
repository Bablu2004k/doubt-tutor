  ...
  return (
    <>
      ...
      <div className="px-3 pt-3 pb-1">
        <button
          onClick={toggleTheme}
          className="press w-full flex items-center justify-between gap-2 px-3 py-2 rounded-xl border border-ink/10 text-xs text-ink/60 hover:text-ink hover:border-ink/20 transition-colors duration-150"
        >
          ...
          <span className="w-8 h-4.5 rounded-full bg-ink/10 relative">
            <span
              className={`absolute top-0.5 w-3.5 h-3.5 rounded-full bg-accent transition-all duration-200 ${
